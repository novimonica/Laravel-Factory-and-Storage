...
unset($__errorArgs, $__bag); ?>"
                                name="firstName" id="firstName" value="<?php echo e($errors->any() ? old('firstName') : $employee->firstname); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                name="lastName" id="lastName" value="<?php echo e($errors->any() ? old('lastName') : $employee->lastname); ?>"
                                placeholder="Enter Last Name">
...
unset($__errorArgs, $__bag); ?>"
                                name="email" id="email" value="<?php echo e($errors->any() ? old('email') : $employee->email); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" name="age"
                                id="age" value="<?php echo e($errors->any() ? old('age') : $employee->age); ?>" placeholder="Enter Age">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ITTS\KULIAH\Semester 4\Pemograman Framework\Modul6\Laravel-Modul6\resources\views/employee/edit.blade.php ENDPATH**/ ?>